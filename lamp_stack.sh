...
SECURITY_GROUP_NAME="lamp-stack-script-security-group"
SECURITY_GROUP_DESC="LAMP Stack Security Group"
AMI_ID="ami-00a0b0bd0bbbd1ecb"  # Replace with the appropriate AMI ID for your desired Linux distribution
